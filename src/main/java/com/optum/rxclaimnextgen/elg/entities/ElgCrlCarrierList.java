 ...
 */
@Entity
@Table(name = "ELG_CRL_CARRIER_LIST")
public class ElgCrlCarrierList {
    private String crlCarrierListName;
    private String crlCarrierListDesc;
    ...
    @Basic
    @Column(name = "CRL_CARRIER_LIST_DESC", nullable = false, length = 25)
    public String getCrlCarrierListDesc() {
        return crlCarrierListDesc;
    }

    public void setCrlCarrierListDesc(String crlCarrierListDesc) {
        this.crlCarrierListDesc = crlCarrierListDesc;
    }
    ...
    public boolean equals(Object o) {
        ...
        ElgCrlCarrierList that = (ElgCrlCarrierList) o;

        if (crlCarrierListName != null ? !crlCarrierListName.equals(that.crlCarrierListName) : that.crlCarrierListName != null)
            return false;
        if (crlCarrierListDesc != null ? !crlCarrierListDesc.equals(that.crlCarrierListDesc) : that.crlCarrierListDesc != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (crlCarrierListDesc != null ? crlCarrierListDesc.hashCode() : 0);
    ...
    public String toString() {
        return "ElgCrlCarrierList{" +
                "crlCarrierListName='" + crlCarrierListName + '\'' +
                ", crlCarrierListDesc='" + crlCarrierListDesc + '\'' +
