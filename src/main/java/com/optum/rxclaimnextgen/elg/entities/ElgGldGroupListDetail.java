 ...
 */
@Entity
@Table(name = "ELG_GLD_GROUP_LIST_DETAIL")
@IdClass(ElgGldGroupListDetailPK.class)
public class ElgGldGroupListDetail {
    ...
    public boolean equals(Object o) {
        ...
        ElgGldGroupListDetail that = (ElgGldGroupListDetail) o;
    ...
    public String toString() {
        return "ElgGldGroupListDetailRepository{" +
