 ...
 */
@Entity
@Table(name = "ELG_GRL_GROUP_LIST")
public class ElgGrlGroupList {
    private String grlGroupListName;
    private String grlGroupListDescriptn;
    ...
    @Basic
    @Column(name = "GRL_GROUP_LIST_DESCRIPTN", nullable = false, length = 25)
    public String getGrlGroupListDescriptn() {
        return grlGroupListDescriptn;
    }

    public void setGrlGroupListDescriptn(String grlGroupListDescriptn) {
        this.grlGroupListDescriptn = grlGroupListDescriptn;
    }
    ...
    public boolean equals(Object o) {
        ...
        ElgGrlGroupList that = (ElgGrlGroupList) o;

        if (grlGroupListName != null ? !grlGroupListName.equals(that.grlGroupListName) : that.grlGroupListName != null)
            return false;
        if (grlGroupListDescriptn != null ? !grlGroupListDescriptn.equals(that.grlGroupListDescriptn) : that.grlGroupListDescriptn != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (grlGroupListDescriptn != null ? grlGroupListDescriptn.hashCode() : 0);
    ...
    public String toString() {
        return "ElgGrlGroupList{" +
                "grlGroupListName='" + grlGroupListName + '\'' +
                ", grlGroupListDescriptn='" + grlGroupListDescriptn + '\'' +
