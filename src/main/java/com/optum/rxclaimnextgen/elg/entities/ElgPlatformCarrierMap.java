 ...
 */
@Entity
@Table(name = "ELG_PLATFORM_CARRIER_MAP")
@IdClass(ElgPlatformCarrierMapPK.class)
public class ElgPlatformCarrierMap {
    ...
    public boolean equals(Object o) {
        ...
        ElgPlatformCarrierMap that = (ElgPlatformCarrierMap) o;
